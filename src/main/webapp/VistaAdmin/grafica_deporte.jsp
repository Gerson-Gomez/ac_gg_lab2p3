...
<body>
            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h7>Preguntas:</h7>
                        <h8>Deportes</h8>
                        <h2 class="card-title mb-4" style="text-align: center">Distribucion por deportes</h2>
                        <canvas id="graficaDeportes" width="400" height="200"></canvas>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        var ctx = document.getElementById('graficaDeportes').getContext('2d');
